...
public class AnchorTag extends AbstractClosingTag {
	...
	public int doEndTag() throws JspException {
		...
		//if parameter combine with  url  have to detach it 
    	...
    	if(user.hasPrivilegeByUrl(privilegeUrl)){
    		return super.doEndTag();// if having Privilege, then homeAction->left.jsp can generate <a> 
    	}else{
		return EVAL_PAGE;// else skip <a> 
		}
	}
